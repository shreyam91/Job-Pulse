...
import {
  Upload, Target, Mail, BarChart3, Zap,
  ArrowRight, Sparkles, Shield, Globe2, ChevronRight, Mic2, Briefcase, Brain, Check,
  Twitter, Linkedin, Github as GithubIcon, Mail as MailIcon, Heart, Star
} from 'lucide-react';
...
const FEATURES = [
  {
    ...
    description: 'Practice with real-time AI mock interviews tailored to your resume and target jobs.',
...
const STEPS = [
  ...
  { step: '02', title: 'AI Job Match', desc: 'Gemini AI ranks the best jobs from across the web' },
  { step: '03', title: 'AI Analyzes', desc: 'Gemini AI scores each job against your profile' },
  { step: '04', title: 'Get Matches', desc: 'See ranked jobs with detailed match breakdowns' },
  { step: '05', title: 'Apply Smart', desc: 'Use cold emails, ATS tips, and track applications' },
  { step: '06', title: 'Mock Interview', desc: 'Practice with Nova, our AI agent, for your target role' },
  { step: '07', title: 'Land the Offer', desc: 'Master the real interview with our feedback and data' },
];
...
const TESTIMONIALS = [
  {
    ...
    company: 'TechCorp',
    avatar: 'SC',
    content: 'JobMatch AI helped me find my dream job in just 2 weeks. The AI matching was incredibly accurate, and the interview prep was a game-changer.',
    rating: 5
  },
  {
    ...
    company: 'StartupXYZ',
    avatar: 'MR',
    content: 'The cold email generator alone saved me hours of work. I got 3x more responses and landed multiple interviews thanks to personalized outreach.',
    rating: 5
  },
  {
    name: 'Emily Johnson',
    ...
    avatar: 'EJ',
    content: 'From resume analysis to mock interviews, JobMatch AI provided everything I needed to level up my career. Worth every penny!',
    rating: 5
  },
  {
    name: 'David Kim',
    ...
    company: 'CloudBase',
    avatar: 'DK',
    content: 'The ATS score optimization helped my resume pass through automated filters. I went from 0 callbacks to 5 interviews in one week.',
    rating: 4
  }
];
    ...
    <div className="min-h-screen bg-[#0a0b0f] text-white overflow-hidden">
      ...
      >
        ...
        <motion.p variants={fadeInUp} custom={2} className="mt-6 text-base sm:text-lg text-white/40 max-w-2xl leading-relaxed">
          Find the perfect job matches and practice for interviews with real-time AI feedback. 
          Everything you need to go from job application to final offer.
        </motion.p>
          ...
          <div className="p-6 grid grid-cols-12 gap-4 min-h-[340px]">
            ...
            <div className="col-span-3 hidden md:block space-y-3">
              ...
              <div className="space-y-2">
                {[8, 6, 10, 7].map((w, i) => (
                  <div key={i} className="h-4 rounded bg-white/[0.03]" style={{ width: `${w * 10}%` }} />
                ))}
              </div>
      ...
      <section className="relative z-10 px-6 md:px-12 lg:px-20 py-24 bg-gradient-to-b from-transparent via-emerald-500/[0.03] to-transparent">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="relative space-y-4">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-20 h-20 md:w-24 md:h-24 rounded-2xl overflow-hidden border border-emerald-500/30 shadow-2xl shadow-emerald-500/20 bg-[#0f1117]">
                    <img 
                  ...
                  <div className="flex-1 bg-[#1a1c23] border border-white/10 rounded-2xl rounded-tl-none p-4 md:p-6 shadow-xl relative mt-4">
                    ...
                    <h4 className="text-emerald-400 text-[10px] font-bold uppercase tracking-wider mb-2 flex items-center gap-1.5">
                      <Mic2 className="w-3 h-3" /> Nova (AI Interviwer)
                    </h4>
                    <p className="text-xs text-white/30 leading-relaxed">
                      &quot;Walk me through a complex architectural challenge you&#39;ve faced. How did you optimize for scalability?&quot;
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-row-reverse items-start gap-4 pr-0 md:pr-12">
                   <div className="flex-shrink-0 w-10 h-10 rounded-full bg-indigo-500/20 border border-indigo-500/30 flex items-center justify-center text-[10px] font-bold text-indigo-400 shadow-lg shadow-indigo-500/10">YOU</div>
                   <div className="flex-1 bg-white/[0.03] border border-white/[0.05] rounded-2xl rounded-tr-none p-4 shadow-lg text-white/70 text-xs md:text-sm leading-relaxed italic">
                      &quot;I recently refactored a legacy monolithic backend into microservices using Node.js and Redis. By implementing a pub/sub pattern, we reduced latency by 40%...&quot;
                   </div>
                </div>
                ...
                >
                   <div className="absolute top-0 right-0 p-3">
                      <div className="text-right">
                         <div className="text-[9px] text-white/30 font-bold uppercase tracking-widest">Analysis Score</div>
                         <div className="text-2xl font-black text-emerald-400">92<span className="text-xs text-white/20">/100</span></div>
                      </div>
                   </div>
                   ...
                   <div className="space-y-4">
                      ...
                      <div className="p-3 rounded-xl bg-emerald-500/5 border border-emerald-500/10 flex items-start gap-3">
                         ...
                         <p className="text-[10px] text-white/50 leading-normal">
                           &quot;Strong mention of Redis pub/sub. To hit 100%, consider briefly touching upon how you handled data consistency during the migration.&quot;
                         </p>
                      </div>
                   </div>
                </motion.div>
            ...
            >
              ...
              <h2 className="text-3xl md:text-5xl font-bold">
                Don&#39;t Just Apply.<br />
                <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">Be Interview Ready.</span>
              </h2>
              <p className="text-base text-white/40 leading-relaxed mb-8 max-w-lg">
                Upload your resume once, and our AI Interview Agent generates mock sessions specifically for your target roles. 
                Answer using your voice or text, and get instant performance analytics.
              </p>
              
              <ul className="space-y-4 mb-10">
                 {[
                   { icon: Brain, title: 'Contextual Questions', desc: 'Questions tailored to *your* unique experience and the job description.' },
                   { icon: Mic2, title: 'Live Simulation', desc: 'Simulate high-pressure interviews with a friendly, intelligent AI avatar.' },
                   { icon: Sparkles, title: 'Granular Feedback', desc: 'Detailed scoring on technical accuracy, clarity, and communication.' },
                 ].map((item, i) => (
      ...
      <section className="relative z-10 px-6 md:px-12 lg:px-20 py-20">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold">
            The Road to <span className="bg-gradient-to-r from-indigo-400 via-emerald-400 to-cyan-400 bg-clip-text text-transparent">Getting Hired</span>
          </h2>
          <p className="text-sm text-white/30 mt-3 max-w-md mx-auto">From resume upload to the final handshake, we&#39;ve got you covered.</p>
        </motion.div>
      ...
      <section className="relative z-10 px-6 md:px-12 lg:px-20 py-20">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold">
            What Our <span className="bg-gradient-to-r from-indigo-400 to-emerald-400 bg-clip-text text-transparent">Users Say</span>
          </h2>
          <p className="text-sm text-white/30 mt-3 max-w-md mx-auto">
            Join thousands of professionals who&#39;ve transformed their career with JobMatch AI
          </p>
        </motion.div>
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex items-center gap-1">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <Star key={i} className={`w-4 h-4 ${i < testimonial.rating ? 'text-yellow-400 fill-yellow-400' : 'text-white/20'}`} />
                      ))}
                    </div>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-white/40">
                    <span className="font-medium text-white/60">{testimonial.role}</span>
                    <span>•</span>
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-white/[0.04] py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
            <div className="col-span-2 lg:col-span-2 space-y-6">
              ...
              <p className="text-white/30 text-sm max-w-xs leading-relaxed">
                Empowering the modern workforce with Gemini-driven career intelligence. Find matches, master interviews, land offers.
              </p>
              <div className="flex gap-4">
                {[Twitter, Linkedin, GithubIcon].map((Icon, i) => (
                  <button key={i} className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-center hover:bg-white/10 transition-all text-white/40 hover:text-white">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                <li><Link href="/" className="text-sm text-white/40 hover:text-white transition-colors">Job Agent</Link></li>
                <li><Link href="/" className="text-sm text-white/40 hover:text-white transition-colors">Interview Agent</Link></li>
                <li><Link href="/pricing" className="text-sm text-white/40 hover:text-white transition-colors">Pricing</Link></li>
                <li><Link href="/" className="text-sm text-white/40 hover:text-white transition-colors">Release Notes</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                <li><Link href="/about" className="text-sm text-white/40 hover:text-white transition-colors">About Us</Link></li>
                <li><Link href="/contact" className="text-sm text-white/40 hover:text-white transition-colors">Contact</Link></li>
                <li><Link href="/about" className="text-sm text-white/40 hover:text-white transition-colors">Careers</Link></li>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between pt-8 border-t border-white/[0.04] gap-4">
            <p className="text-xs text-white/20">© 2026 JobMatch AI. All rights reserved.</p>
