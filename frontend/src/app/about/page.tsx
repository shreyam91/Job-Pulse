  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-24 max-w-3xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center tracking-tight">Our Mission</h1>
        <p className="text-xl text-muted-foreground leading-relaxed mb-8 text-center font-medium">
        ...
        <div className="prose prose-lg dark:prose-invert mx-auto">
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">Designed for the Modern Professional</h2>
          <p>
